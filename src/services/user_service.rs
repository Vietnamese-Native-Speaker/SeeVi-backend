...
impl UserService {
    pub async fn registraion(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn authentication(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    //Forget password = change password
    pub async fn change_password(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn change_email(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn change_username(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn change_name(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    ...
    pub async fn remove_cv(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn add_email(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
    pub async fn remove_email(&mut self) -> Result<User, dyn Box<impl Debug + Clone + Copy>> {
        unimplemented!()
    }
